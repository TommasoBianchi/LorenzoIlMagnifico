...
public class Familiar {
	...
	/**
	 * @param player the player owning this familiar
	 * @param familiarColor the color of this familiar (WHITE, ORANGE, BLACK or UNCOLORED)
	 */
	...
	/**
	 * @param value the new value of this familiar
	...
	/**
	 * @param bonus a new bonus to add to this familiar (not given by servants)
	 */
	...
	/**
	 * @param value whether or not this familiar has been placed in a slot
	 */
	...
	/**
	 * @param cost the cost (in servants) of increasing by one the value of this familiar 
	 */
